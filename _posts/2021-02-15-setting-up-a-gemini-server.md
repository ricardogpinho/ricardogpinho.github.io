...
So, today I embargoed on this quest of setting up my own Gemini server and serving my very first capsule.
...
But following the instructions on the repository, something wasn't working.
